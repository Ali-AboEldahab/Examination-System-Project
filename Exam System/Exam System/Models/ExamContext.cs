...
namespace Exam_System.Models
{
    public class ExamContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=DESKTOP-M3I8RFQ\\SQLEXPRESS;Database=ExamSystemProj;Encrypt=false;Trusted_Connection=True;TrustServerCertificate=True");
        }
